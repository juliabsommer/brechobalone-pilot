  ...
  return (
    <div className="relative flex justify-center">
      ...
      <div className="animate-float relative w-[210px] overflow-hidden rounded-[2.5rem] border-[5px] border-white/15 shadow-[0_32px_64px_rgba(0,0,0,0.5)] ring-1 ring-white/10 md:w-[230px]">
        {/* Notch bar */}
        <div className="flex items-center justify-center bg-[#2a1214] py-2.5">
        ...
        <div className="flex items-center justify-between border-b border-gray-100 bg-white px-3 py-2.5">
          <div className="leading-tight">
            <p className="text-[11px] font-bold text-[#2d1618]">Balonê</p>
            <p className="text-[8px] uppercase tracking-wider text-[#7a5558]">Brechó · Fê Bassi</p>
          </div>
          <div className="flex gap-1">
            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#a85f68] text-[8px] font-bold text-white">0</span>
            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#a85f68] text-[8px] font-bold text-white">0</span>
          </div>
        </div>
        ...
        <div className="flex gap-1.5 bg-white px-3 pb-2 pt-1.5">
          <span className="rounded-full bg-[#3d1e20] px-2.5 py-0.5 text-[8px] font-medium text-white">Tudo</span>
          <span className="rounded-full border border-gray-200 px-2.5 py-0.5 text-[8px] text-[#7a5558]">Blusas</span>
          <span className="rounded-full border border-gray-200 px-2.5 py-0.5 text-[8px] text-[#7a5558]">Camisas</span>
        </div>

        {/* Product grid */}
        <div className="grid grid-cols-2 gap-1.5 bg-[#f7edec] p-2">
          {/* Card 1 */}
          <div className="overflow-hidden rounded-xl bg-white shadow-sm">
            ...
            <div className="p-1.5">
              <p className="text-[8px] font-semibold leading-tight text-[#2d1618]">Camisa Yolo</p>
              <p className="text-[7px] text-[#7a5558]">Tam. G · Fendi</p>
              <p className="mt-0.5 text-[8px] font-bold text-[#a85f68]">R$ 128,00</p>
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-xl bg-white shadow-sm">
            ...
            <div className="p-1.5">
              <p className="text-[8px] font-semibold leading-tight text-[#2d1618]">Blusa Zara</p>
              <p className="text-[7px] text-[#7a5558]">Tam. M · Off white</p>
              <p className="mt-0.5 text-[8px] font-bold text-[#a85f68]">R$ 128,00</p>
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-xl bg-white shadow-sm">
            ...
            <div className="p-1.5">
              <p className="text-[8px] font-semibold leading-tight text-[#2d1618]">Blusa Zara</p>
              <p className="text-[7px] text-[#7a5558]">Tam. P · Bege</p>
              <p className="mt-0.5 text-[8px] font-bold text-[#a85f68]">R$ 95,00</p>
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-xl bg-white shadow-sm opacity-60">
            ...
            <div className="p-1.5">
              <p className="text-[8px] font-semibold leading-tight text-[#2d1618]">Camisa Yolo</p>
              <p className="text-[7px] text-[#7a5558]">Tam. G · Cinza</p>
              <p className="mt-0.5 text-[8px] font-bold text-[#a85f68]">R$ 110,00</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between border-t border-gray-100 bg-white px-3 py-2">
          <p className="text-[8px] text-[#7a5558]">Nenhuma selecionada</p>
